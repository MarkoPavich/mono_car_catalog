...
function NavbarResponsiveUserMenu({isSmallScreen, t}){
    ...
    const userMenuSmallScreen = (
        ...
        className="l-navbar-user-menu-mobile"
...
function toggleMobileMenu(){
    ...
    if(toggleElem.className === activeClassName) toggleElem.className = inactiveClassName;
