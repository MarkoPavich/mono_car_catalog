...
const LoginForm = observer(({t}) => {
    ...
    function handleSubmitLogin(event){
        ...
        const inputs = {
            username: document.querySelector("#app-root > section > main > div > form > div:nth-child(1) > input"),
            loginPass: document.querySelector("#app-root > section > main > div > form > div:nth-child(2) > input")
        }
